...
{GREAT-NS \\ Lecture 7: Isotopes and the Chart of Nuclides 
...
Tritium ($^{3}$H)  is another isotope of hydrogen, with one proton and three two neutrons
\vspace{10pt} 
\begin{figure}
...
\end{columns}
\vspace{10pt}
Fun fact: He was an avid photographer and took many pictures of events and people surrounding physics during his time. He wrote on the history of modern physics.
\let\thefootnote\relax\footnote{\tiny{\underline{\textcolor{blue}{\href{https://www.nap.edu/read/10470/chapter/18\#299}{Biographical Memories: Emilio Segr\`{e}}}}}}
\end{frame}
...
\begin{figure}
\includegraphics[width=0.9\textwidth]{Sn+Legend.png}
\end{figure}
\end{frame}
...
\column{0.5\textwidth}
\begin{figure}
\includegraphics[width=0.8\textwidth]{Camera.png}
\end{figure}
\end{columns}
...
\column{0.5\textwidth}
\begin{figure}
\includegraphics[width=\textwidth]{SolarFlare.jpg}
\end{figure}
\column{0.5\textwidth}
\begin{itemize}
\item The sun burns through fusion: H $\rightarrow$ He
\item As stars evolve, other fusion processes can take ove
