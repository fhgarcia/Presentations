...
Change in chemical reaction rates when an atom is replaced with different isotope
\begin{itemize}
\item Can be used to determine preferable reaction pathways for optimization
\item Change is most pronounced with large differences in mass - effect is related to vibration of the bonds
\end{itemize}
\end{frame}
